...
This exercise is based on a Used Car dataset from Kaggle (seen in data folder).  CRISP-DM process provides a framework for working through this problem and is employed as below.
